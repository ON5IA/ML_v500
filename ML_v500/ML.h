...
//
#define SCREENSAVE_CUST         1    // Normally 0 for disabled, 1 to enable.
                                     // Disabled for the last tuned frequency to be shown
#define SCREENSAVE_CUST_TEXT "ON5IA - Frederik"  // Custom Screensaver msg, max 20 char
...
#define DISP_CALLSIGN      "ON5IA - Frederik   "
...
#define  ENC_MENURESDIVIDE  45    // Encoder resolution reduction when in Menu
#define  ENC_TUNERESDIVIDE   6    // Encoder resolution reduction when turning
...
#define BACKLASH_ANGLE        1   // 5 equals 25 steps, which equals 360 * 25/200 = 45 degrees
...
#if PSWR_AUTOTUNE
const int EnactSW          = A9;  // Analog Input A9, Equals pin 23
#else
...
//
#define ANALOGOUTPIN     0    // 1 for pin A14, 0 for pin 27
//
