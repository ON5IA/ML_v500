...
uint8_t multipurpose_pushbutton(void)
{
  ...
  */
  ...
  //ON5IA
  //For Teensy 4.0 which has only a 10 bit ADC (1024) 
  uint16_t        push_adval;      // Returned AD value of push button
  #define NOTPUSHED   950          // AD buttons not pushed if EnactSW AD above this value
  #define SW1         128          // SW1 (EnactSW) Pushed if EnactSW AD below this value
                                   // Inbetween values for SW5 (Autotune Request) pushed
  #define SW4         454          // SW4: 1024*2k2/(2k2+4k7) = 326
  #define SW5         604          // SW5: 1024*4k7/(4k7+4K7) = 512
                                   // SW6: 1024*10k/(10k+4k7) = 696,
                                   // is between SW5 and NOTPUSHED
  //ON5IA                                 
